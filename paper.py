...
class ArxivPaper:
    ...
    def tldr(self) -> str:
        ...
        llm = get_llm()
        prompt = """Given the title, abstract, introduction and the conclusion (if any) of a paper in latex format, translate its title into Chinese, and generate a one-sentence TLDR summary in __LANG__:
